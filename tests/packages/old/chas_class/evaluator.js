...
function a(str) { return new Token.Atom(str) }

class EvalError extends BeaconError{}

class Evaluator extends Duplex {
    constructor(options) {
        super({
    ...
    eval(expr) {
        ...
        if (a('set').eq(first)) return this.do_set(expr)
        // if (a('lambda') == first) return this.do_lambda(expr)
